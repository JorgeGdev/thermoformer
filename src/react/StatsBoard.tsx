    ...
    <div className="max-w-[1200px] mx-auto p-2 sm:p-4">
      ...
      <div className="flex flex-wrap gap-2 items-center mb-4">
          ...
          {(["today", "week", "month"] as Range[]).map((r) => (
            <button
              ...
              className={`px-4 py-2 rounded-md transition-all ${
                range === r
                  ? "bg-slate-600 text-white border-2 border-white/30"
                  : "bg-slate-700/40 dark:bg-slate-800 border-2 border-white/20"
              }`}
            >
        ...
        <select
          ...
          className="ml-2 px-3 py-2 rounded-md bg-slate-500/40 dark:bg-slate-800"
        >
        ...
        <select
          ...
          className="px-3 py-2 rounded-md bg-slate-500/40 dark:bg-slate-800"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
        <div className="rounded-xl border border-slate-800 bg-slate-500/40 dark:bg-slate-900 p-4">
      ...
      {/* BAR CHART */}
      <div className="rounded-xl border border-slate-800 bg-slate-400 dark:bg-slate-900 p-4 mb-6">
        ...
        <div className="w-full h-60">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={hourData}>
              ...
              />
              <Tooltip
              contentStyle={{ background: "#222", color: "#fff", fontSize: 14 }}
              labelStyle={{ color: "#fff" }}
              itemStyle={{ color: "#fff" }}
              />
              <Bar dataKey="Packets" fill="#015A4D" />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
